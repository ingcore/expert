  ...
  if (geschosseOberirdisch > 0 && fluchtniveau > 0) {
    ...
    if (mittlereGeschosshoehe > 6) {
      befunde.push({
        ...
        beschreibung: `Aus ${fmt(fluchtniveau, 1)} m Fluchtniveau bei ${geschosseOberirdisch} Geschoß(en) ergibt sich eine mittlere Geschoßhöhe von ${fmt(mittlereGeschosshoehe, 1)} m. Beide Angaben sind zu prüfen.`,
